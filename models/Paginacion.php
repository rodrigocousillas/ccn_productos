    ...
    class Paginacion  extends ActiveRecord {
        ...
        public function enlace_anterior() {
            ...
            if($this->pagina_anterior()) {
                $html .= "<li class=\"page-item\"><a class=\"page-link\" href=\"?page={$this->pagina_anterior()}\">&laquo;</a></li>";
            }
            return $html;
        }
        ...
        public function enlace_siguiente() {
            ...
            if($this->pagina_siguiente()) {
                $html .= "<li class=\"page-item\"><a class=\"page-link\" href=\"?page={$this->pagina_siguiente()}\">&raquo;</a></li>";
            }
            return $html;
        }
